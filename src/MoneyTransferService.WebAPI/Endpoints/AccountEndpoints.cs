...
public static class AccountEndpoints
{
    public static IEndpointRouteBuilder MapAccountEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapPost("/", CreateAccountAsync).WithName("CreateAccount");
        group.MapGet("/{id:guid}", GetAccountByIdAsync).WithName("GetAccountById");
        group.MapGet("/{id:guid}/balance", GetAccountBalanceAsync).WithName("GetAccountBalance");
